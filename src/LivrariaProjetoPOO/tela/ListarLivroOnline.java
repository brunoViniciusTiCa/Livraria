 ...
 */
public class ListarLivroOnline extends javax.swing.JFrame {
    
    private LivroOnlineFachada livroOnlineFachada = null;
    
    private DefaultTableModel modelo = new DefaultTableModel();
    
    private List<LivroOnline> listaLivroOnline = new ArrayList<>();
    ...
    private void preencherTabelaLivro(){
        ...
        try {
            //limpando a lista
            listaLivroOnline.clear();
            //preenchendo a lista com as informações do banco
            listaLivroOnline = livroOnlineFachada.selecionarLivro();
        ...
        for (LivroOnline livroOnline : listaLivroOnline) {
            
            Object object [] = new Object[]{
                livroOnline.getIdLivroOnline(),
                livroOnline.getCodlivro(),
                livroOnline.getTituloLivro(),
                livroOnline.getAutorLivro(),
                livroOnline.getDescricaoLivro(),
                livroOnline.getSiteLivro(),
                livroOnline.getClubeLivro()
            };
    ...
    private void initComponents() {
        ...
        lbl_tela.setText("Listagem de livros Onlines");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Livro Online", "Cod Livro", "Titulo", "Autor", "Descrição", "Site Livro", "Clube Livro"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(btn_Atualizar2, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(46, 46, 46)
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            LivroOnline livroSelecionado ;
            livroSelecionado = listaLivroOnline.get(posicaoSelecionada);
            //chamando tela no modo de editar, passando o autor selecionado como parametro no construtor
            CadastrarLivroOnline telaCadastrarLivroOnline = new CadastrarLivroOnline(CadastrarLivroOnline.TELA_MODO_EDITAR , livroSelecionado);
            telaCadastrarLivroOnline.setVisible(true);
            abrindoTela = true;
            this.dispose();
        }
        else{
    ...
    private void btn_deletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deletarActionPerformed
        ...
        if (posicaoSelecionada > -1) {
            try {
                LivroOnline livroSelecionadoOnline ;
                livroSelecionadoOnline = listaLivroOnline.get(posicaoSelecionada);

                int resutBtnClick = Uteis.ConfirmeDialog(this, "Deseja realmente deletar esse autor?");

                if (resutBtnClick == JOptionPane.YES_OPTION) {
                    livroOnlineFachada.deleteLivro(livroSelecionadoOnline);
    ...
    private void btn_cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cadastrarActionPerformed
        ...
        CadastrarLivroOnline telaCadastrarLivroOnline = new CadastrarLivroOnline(CadastrarLivroOnline.TELA_MODO_CADASTRAR, null);
        telaCadastrarLivroOnline.setVisible(true);
        abrindoTela = true;
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarLivroOnline.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarLivroOnline().setVisible(true);
            }
        });
    }
